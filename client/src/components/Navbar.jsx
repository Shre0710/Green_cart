...
const Navbar = () => {
    ...
    return (
        <nav className="flex items-center justify-between px-4 md:px-14 py-4 border-b border-gray-300 bg-white relative transition-all">
            {/* Fixed onClick spelling and capitalization */}
            ...
            <div className="hidden lg:flex items-center text-sm gap-2 border border-gray-300 rounded-full">
                <input
                    onChange={(e) => setSearchQuery(e.target.value)}
                    className="py-1.5 w-full bg-transparent outline-none placeholder-gray-500 px-4"
                    type="text"
            ...
            {/* Fixed onClick spelling and capital O */}
            ...
            {!user ? (
                ...
                <div className='relative group'>
                    ...
                    <ul className='hidden group-hover:block absolute top-10 right-0 bg-white shadow border border-gray-200 py-2.5 w-30 rounded-md text-sm z-40'>
                        ...
                        {/* Fixed onClick spelling with capital O */}
